...
IMAGE_UPLOAD_SERVICE = os.environ.get("DISFACTORY_IMAGE_UPLOAD_SERVICE", "local").lower()
IMAGE_UPLOAD_BUCKET = os.environ.get("DISFACTORY_IMAGE_UPLOAD_BUCKET")
IMAGE_UPLOAD_REGION = os.environ.get("DISFACTORY_IMAGE_UPLOAD_REGION", "auto")
IMAGE_UPLOAD_ENDPOINT_URL = os.environ.get("DISFACTORY_IMAGE_UPLOAD_ENDPOINT_URL")
IMAGE_UPLOAD_ACCESS_KEY = os.environ.get("DISFACTORY_IMAGE_UPLOAD_ACCESS_KEY")
IMAGE_UPLOAD_SECRET_KEY = os.environ.get("DISFACTORY_IMAGE_UPLOAD_SECRET_KEY")
IMAGE_UPLOAD_PUBLIC_URL_BASE = os.environ.get("DISFACTORY_IMAGE_UPLOAD_PUBLIC_URL_BASE")
