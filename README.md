...
## Data Source
The initial data are provided by [Ronny Wang](https://github.com/ronnywang) via [disfactory-crawler](https://github.com/ronnywang/disfactory-crawler). We maintain a [copy](backend/fixtures/full-info.csv) crawed at 2019/7/20.
